...
:deep(.menu_scrollbar) {
	...
	.menu_view {
		...
		.el-menu-item {
			...
			margin: 0 auto 10px;
			color: #666;
			background: url(http://codegen.caihongy.cn/20221203/a14e669e5c084257801eac3aa067d8e0.png) left top no-repeat,url(hhttp://localhost:8080/mettingManage/file/8028bee9d6b54bb0922eb164af4b447e.png) right bottom no-repeat,#f6f6f6;
			font-weight: 500;
		...
		.el-menu--inline {
			...
			.menu_item_view {
				...
				margin: 0 auto 8px;
				color: #666;
				background: url(http://localhost:8080/mettingManage/file/520e48141a194242a6178062e563e0cd.png) left bottom no-repeat,url(http://codegen.caihongy.cn/20221203/8e49820ace4d4c1392bfbbe018036956.png) right top no-repeat,#eee;
				display: block;
				border-color: #fbbe62;
				border-width: 0px;
				line-height: 38px;
