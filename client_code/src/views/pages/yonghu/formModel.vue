...
const getDetail = () => {
  context
    ...
    .then((res) => {
      bannerList.value = res.data.data.touxiang
        ? res.data.data.touxiang.split(',')
        : []
...
.detail_view {
  ...
  .info_view {
    ...
    padding: 30px 4% 10px;
    margin: 0 0 0px;
    background: url(http://localhost:8080/mettingManage/file/974a5cd5eb9840c9b1a4576231567b5c.png);
